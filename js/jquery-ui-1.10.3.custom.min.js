...
$.fn.customFileInput = function(options){
	...
	var settings	= jQuery.extend({
		...
		feedback_text		: 'No image uploaded',
		button_text			: 'Browse',
		button_change_text	: 'Upload other image'
	}, options);
	...
	fileInput
		...
		var uploadButton = $('<span class="add-on customfile-button" aria-hidden="true">' + settings.button_text + '</span>');
